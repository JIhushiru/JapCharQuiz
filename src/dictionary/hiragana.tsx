...
const hiraganaArray = [
  ...
  { kana: "だ", romaji: "da" }, { kana: "ぢ", romaji: "dzi" }, { kana: "づ", romaji: "dzu" }, { kana: "で", romaji: "de" }, { kana: "ど", romaji: "do" },
